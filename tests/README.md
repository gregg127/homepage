...
| `pages.test.js`           | Each built HTML page has the correct `<title>`, a non-empty `<meta name="description">`, `lang="en"`, canonical URL, Open Graph and Twitter Card tags; only 404 is `noindex` |
